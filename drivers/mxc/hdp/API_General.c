...
EXPORT_SYMBOL(CDN_API_LoadFirmware);
...
EXPORT_SYMBOL(CDN_API_General_Test_Echo_Ext_blocking);
...
EXPORT_SYMBOL(CDN_API_General_getCurVersion);
...
EXPORT_SYMBOL(CDN_API_Get_Event);
...
EXPORT_SYMBOL(CDN_API_CheckAlive_blocking);
...
EXPORT_SYMBOL(CDN_API_MainControl_blocking);
...
EXPORT_SYMBOL(CDN_API_SetClock);
...
EXPORT_SYMBOL(CDN_API_General_Read_Register_blocking);
...
EXPORT_SYMBOL(CDN_API_General_Write_Register_blocking);
