...
EXPORT_SYMBOL(CDN_API_DPTX_Read_EDID_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_SetHostCap_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_ReadEvent_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_Set_VIC_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_SetVideo_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_ReadLinkStat_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_TrainingControl_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_GetHpdStatus_blocking);
...
EXPORT_SYMBOL(CDN_API_DPTX_SetDbg_blocking);

static int __init imx_hdp_common_api_init(void)
{
        return 0;
}
module_init(imx_hdp_common_api_init);

static void __exit imx_hdp_common_api_exit(void)
{
        return;
}
module_exit(imx_hdp_common_api_exit);

MODULE_AUTHOR("Sandor Yu <Sandor.yu@nxp.com>, Wen He <wen.he_1@nxp.com>");
MODULE_DESCRIPTION("IMX8QM/LS1028A HD Display Controller Common API");
MODULE_LICENSE("GPL");
