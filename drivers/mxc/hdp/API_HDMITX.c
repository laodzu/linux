...
EXPORT_SYMBOL(CDN_API_HDMITX_READ_EDID_blocking);
...
EXPORT_SYMBOL(CDN_API_HDMITX_Set_Mode_blocking);
...
EXPORT_SYMBOL(CDN_API_HDMITX_Init_blocking);
...
EXPORT_SYMBOL(CDN_API_HDMITX_SetVic_blocking);
...
EXPORT_SYMBOL(CDN_API_HDMITX_GetHpdStatus_blocking);
