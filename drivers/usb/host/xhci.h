...
#define XHCI_DIS_U1U2_WHEN_U3	BIT_ULL(60)
#define XHCI_REVERSE_IN_OUT     BIT_ULL(59)
#define XHCI_STOP_TRANSFER_IN_BLOCK	BIT_ULL(58)
#define XHCI_STOP_EP_IN_U1	BIT_ULL(57)
